...
import { User, Heart, LogOut, X, ChevronRight } from 'lucide-react';
import { useMobileNav } from '../contexts/MobileNavContext';
import { useAuth } from '../contexts/AuthContext';
import { useNavigate } from 'react-router-dom';

export default function ProfileMenu() {
  const { isProfileMenuOpen, setIsProfileMenuOpen, setActiveTab } = useMobileNav();
  ...
  const menuItems = [
    { label: 'Account', icon: User, path: '/user-dashboard', tab: 'account' },
