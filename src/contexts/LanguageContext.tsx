...
const translations: Record<Language, Record<string, string>> = {
  English: {
    ...
    'tool.title-analyzer.desc': 'Evaluate your title strength',
    ...
    'tool.viral-hooks.desc': 'Generate high-CTR video hooks',
    ...
    'tool.thumb-text.desc': 'High-CTR text for thumbnails',
    'tool.content-planner.desc': 'Plan your video schedule',
  ...
  'हिन्दी': {
    ...
    'tool.title-analyzer.desc': 'अपने टाइटल की ताकत का विश्लेषण करें',
    ...
    'tool.viral-hooks.desc': 'हाई-CTR वीडियो हुक जनरेट करें',
    ...
    'tool.thumb-text.desc': 'थंबनेल के लिए हाई-CTR टेक्स्ट',
    'tool.content-planner.desc': 'अपना वीडियो शेड्यूल प्लान करें',
