...
const translations: Record<Language, Record<string, string>> = {
  English: {
    'hero.title': 'Grow Your YouTube Channel',
    'hero.subtitle': 'Faster Than Ever',
    'hero.description': 'The ultimate all-in-one suite for creators. Optimize SEO, generate viral ideas, and track your growth with professional-grade tools.',
    'hero.badge': '🚀 20+ Professional Creator Tools',
  ...
  'हिन्दी': {
    'hero.title': 'अपने YouTube चैनल को बढ़ाएं',
    'hero.subtitle': 'पहले से कहीं ज्यादा तेज़',
    'hero.description': 'Creators के लिए सबसे बेहतरीन all-in-one suite. SEO optimize करें, viral ideas generate करें, और professional tools के साथ अपनी growth track करें।',
    'hero.badge': '🚀 20+ प्रोफेशनल क्रिएटर टूल्स',
